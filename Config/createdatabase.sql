...
CREATE TABLE IF NOT EXISTS camagru.`user`(`id` INT(11) NOT NULL AUTO_INCREMENT, `pseudo` Varchar(32), `pass` Varchar(200), `email` LONGTEXT, `creation_date` DATE NOT NULL, `valid` INT(1), PRIMARY KEY(`id`))ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS camagru.`comment`(`id` INT(11) NOT NULL AUTO_INCREMENT, `user_id` INT(11), `image` INT(11), `date` DATE NOT NULL, `comment` LONGTEXT, `like` INT(11), `not_like` INT(11), PRIMARY KEY(`id`))ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS camagru.`like`(`id` INT(11) NOT NULL AUTO_INCREMENT, `user_id` INT(11), `image_id` INT(11), PRIMARY KEY(`id`))ENGINE=MyISAM DEFAULT CHARSET=latin1;


INSERT INTO camagru.user (pseudo, email, pass, creation_date) VALUES("rgermain", "a@a", "a", "2018-02-08");