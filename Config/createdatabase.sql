...
CREATE TABLE IF NOT EXISTS camagru.`notification`(`id` INT(11) NOT NULL AUTO_INCREMENT, `notiffollow` INT(1), `notiflike` INT(1), `notifcomment` INT(1), PRIMARY KEY(`id`))ENGINE=MyISAM DEFAULT CHARSET=latin1;
