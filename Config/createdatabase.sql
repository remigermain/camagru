...
CREATE TABLE IF NOT EXISTS camagru.`user`(`id` INT(11) NOT NULL AUTO_INCREMENT, `pseudo` Varchar(32), `pass` Varchar(200), `email` LONGTEXT, `creation_date` DATE NOT NULL, `token` INT(1), `notif` INT(1), PRIMARY KEY(`id`))ENGINE=MyISAM DEFAULT CHARSET=latin1;
