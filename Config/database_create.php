...
return array(
    ...
    "CREATE TABLE IF NOT EXISTS camagru.`image`(`id` INT(11) NOT NULL AUTO_INCREMENT, `login` INT(11), `image` LONGTEXT, `date` DATE NOT NULL, `category` INT(11), `comment` INT(11), `like` INT(11), PRIMARY KEY(`id`))ENGINE=MyISAM DEFAULT CHARSET=latin1",   // table IMAGE
